    ...
    def think(self, question, username):
        ...
        for step in range(self.worker_config.max_depth):
            ...
            step_prompt += (
                ...
                "- If no action is needed for the task, reason forward logically toward completing the user given task.\n"
                ...
                "- Do not use actions that are not needed or related to the task.\n"
