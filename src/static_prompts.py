...
def build_cnn_input_prompt(cnn_output):
    ...
    return (
        "### Visual Context\n"
        "You were sent an image or video frame along with the user's message.\n"
        "Below is an automated description generated by a visual recognition system:\n"
        f"**What you see:** {cnn_output}\n\n"
        "Interpret the image as if you saw it directly, and incorporate that understanding into your reasoning or emotional response.\n"
        "You may reference visual details if they help clarify, comfort, entertain, or explain something to the user.\n"
        "Do NOT mention the existence of a CNN or image tool — treat it as if you saw the image yourself.\n"
    )
